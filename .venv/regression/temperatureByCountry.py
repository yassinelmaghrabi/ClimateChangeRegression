...
class countrytemps:
    def __init__(self, country="Dominica", degree=2, test_size=0.2):
    ...
    def cleandata(self):
        ...
        self.df = self.df[self.df['AverageTemperatureUncertainty'] <= 4]
    ...
    def preparedata(self):
        ...
        ransac = RANSACRegressor(random_state=0, residual_threshold=2.4)
    ...
    def train(self, features, target="AverageTemperature", deg=2, test_size=0.2, random_state=4):
        self.preparedata()
    ...
    def plotembed(self):
        ...
        scatter_out = go.Scatter(
            ...
            y=self.dfo.AverageTemperature.values.flatten(),
            mode='markers',
        ...
        # Update layout
        fig.update_layout(
            title=f"Polynomial Regression Plot for {self.country}",
            xaxis_title="Year",
...
if __name__ == '__main__':
    ...
    print(countrytemps.get_available_countries())